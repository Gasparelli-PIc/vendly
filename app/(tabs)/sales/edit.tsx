...
export default function EditSale() {
  ...
  const [adjustmentMode, setAdjustmentMode] = useState<
    "none" | "discount" | "additional"
  >("none");
  const [discountType, setDiscountType] = useState<"percentage" | "value">(
    "percentage",
  );
  const [discountValue, setDiscountValue] = useState("");
  const [additionalType, setAdditionalType] = useState<"percentage" | "value">(
    "percentage",
  );
  ...
  if (adjustmentMode === "additional" && additionalValue) {
    const additional =
      additionalType === "value"
        ...
        : parseFloat(additionalValue.replace(",", "."));
            ...
            <View style={{ paddingHorizontal: 16, gap: 16 }}>
                ...
                <View style={{ gap: 16 }}>
                  <View>
                    ...
                    >
                      <Text
                        style={{
                          color: currentProductId ? "#111827" : "#9CA3AF",
                          fontSize: 16,
                        }}
                      >
                      ...
                      >
                        <ChevronDown
                          size={20}
                          color={isDropdownOpen ? "#16A34A" : "#9CA3AF"}
                        />
                      </View>
                    </TouchableOpacity>
                        ...
                        {products.map((p, index) => (
                          <TouchableOpacity
                            ...
                            onPress={() => {
                              ...
                              setCurrentPrice(
                                formatCurrencyInput(p.basePrice.toFixed(2)),
                              );
                              setIsDropdownOpen(false);
                            }}
                          >
                              ...
                              style={{
                                color:
                                  p.id === currentProductId
                                    ...
                                    : "#111827",
                                fontWeight:
                                  p.id === currentProductId ? "600" : "normal",
                                fontSize: 16,
                              }}
                            >
                  ...
                  <View style={{ flexDirection: "row", gap: 12 }}>
                    <View style={{ flex: 1 }}>
                      <VendlyInput
                        ...
                        value={currentPrice}
                        onChangeText={(text) =>
                          setCurrentPrice(formatCurrencyInput(text))
                        }
                      />
                    </View>
                    <View style={{ flex: 1 }}>
                      <VendlyInput
                        ...
                        onChangeText={(text) =>
                          setCurrentQuantity(text.replace(/\D/g, ""))
                        }
                      />
                    </View>
                  </View>
                  ...
                  <VendlyButton
                    ...
                    disabled={
                      !currentProductId || !currentPrice || !currentQuantity
                    }
                  >
                    <View
                      style={{
              ...
              {cartItems.length > 0 && (
                <VendlyCard>
                  ...
                  >
                    Ajuste de valor (opcional)
                  </Text>

                  <View
                    style={{ flexDirection: "row", gap: 8, marginBottom: 16 }}
                  >
                    {(["none", "discount", "additional"] as const).map(
                      (mode) => (
                        <TouchableOpacity
                          key={mode}
                          activeOpacity={0.7}
                          ...
                          style={{
                            ...
                            borderWidth: 2,
                            borderColor:
                              adjustmentMode === mode ? "#16A34A" : "#E5E7EB",
                            backgroundColor:
                              adjustmentMode === mode
                                ? "rgba(22, 163, 74, 0.05)"
                                : "#FFFFFF",
                        ...
                        >
                          <Text
                            style={{
                              ...
                              fontWeight: "500",
                              color:
                                adjustmentMode === mode ? "#16A34A" : "#6B7280",
                            }}
                          >
                            {mode === "none"
                              ? "Nenhum"
